...
class YOLOv11InferNode(Node):
    def __init__(self):
        super().__init__('yolov11_infer_node')

        self.declare_parameter('model_path', 'yolo_experiments_ws/models/yolov11.pt')
        ...
        self.get_logger().info(f'YOLOv11 Inference Node started with model: {model_path}')
