...
class Metaclass_MoveLine_Request(type):
    """Metaclass of message 'MoveLine_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_line__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_line__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_line__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_line__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_line__request
...
class MoveLine_Request(metaclass=Metaclass_MoveLine_Request):
    """Message class 'MoveLine_Request'."""
...
class Metaclass_MoveLine_Response(type):
    """Metaclass of message 'MoveLine_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_line__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_line__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_line__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_line__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_line__response
...
class MoveLine_Response(metaclass=Metaclass_MoveLine_Response):
    """Message class 'MoveLine_Response'."""
...
class Metaclass_MoveLine(type):
    """Metaclass of service 'MoveLine'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveLine')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__move_line

            from doosan_m0609_msgs.srv import _move_line
            if _move_line.Metaclass_MoveLine_Request._TYPE_SUPPORT is None:
                _move_line.Metaclass_MoveLine_Request.__import_type_support__()
            if _move_line.Metaclass_MoveLine_Response._TYPE_SUPPORT is None:
                _move_line.Metaclass_MoveLine_Response.__import_type_support__()


class MoveLine(metaclass=Metaclass_MoveLine):
    from doosan_m0609_msgs.srv._move_line import MoveLine_Request as Request
    from doosan_m0609_msgs.srv._move_line import MoveLine_Response as Response
