...
class Metaclass_GetRobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetRobotMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_robot_mode
...
class GetRobotMode(metaclass=Metaclass_GetRobotMode):
    from doosan_m0609_msgs.srv._get_robot_mode import GetRobotMode_Request as Request
    from doosan_m0609_msgs.srv._get_robot_mode import GetRobotMode_Response as Response
