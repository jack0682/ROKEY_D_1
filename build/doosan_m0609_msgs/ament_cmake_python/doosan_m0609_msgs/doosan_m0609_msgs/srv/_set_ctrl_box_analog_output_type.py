...
class Metaclass_SetCtrlBoxAnalogOutputType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetCtrlBoxAnalogOutputType')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _set_ctrl_box_analog_output_type
...
class SetCtrlBoxAnalogOutputType(metaclass=Metaclass_SetCtrlBoxAnalogOutputType):
    from doosan_m0609_msgs.srv._set_ctrl_box_analog_output_type import SetCtrlBoxAnalogOutputType_Request as Request
    from doosan_m0609_msgs.srv._set_ctrl_box_analog_output_type import SetCtrlBoxAnalogOutputType_Response as Response
