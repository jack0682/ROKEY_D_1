...
class Metaclass_Fkin_Request(type):
    """Metaclass of message 'Fkin_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fkin__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fkin__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fkin__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fkin__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fkin__request
...
class Fkin_Request(metaclass=Metaclass_Fkin_Request):
    """Message class 'Fkin_Request'."""
...
class Metaclass_Fkin_Response(type):
    """Metaclass of message 'Fkin_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fkin__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fkin__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fkin__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fkin__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fkin__response
...
class Fkin_Response(metaclass=Metaclass_Fkin_Response):
    """Message class 'Fkin_Response'."""
...
class Metaclass_Fkin(type):
    """Metaclass of service 'Fkin'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.Fkin')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__fkin

            from doosan_m0609_msgs.srv import _fkin
            if _fkin.Metaclass_Fkin_Request._TYPE_SUPPORT is None:
                _fkin.Metaclass_Fkin_Request.__import_type_support__()
            if _fkin.Metaclass_Fkin_Response._TYPE_SUPPORT is None:
                _fkin.Metaclass_Fkin_Response.__import_type_support__()


class Fkin(metaclass=Metaclass_Fkin):
    from doosan_m0609_msgs.srv._fkin import Fkin_Request as Request
    from doosan_m0609_msgs.srv._fkin import Fkin_Response as Response
