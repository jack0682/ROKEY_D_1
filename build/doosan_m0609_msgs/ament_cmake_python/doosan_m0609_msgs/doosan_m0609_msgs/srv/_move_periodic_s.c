...
bool doosan_m0609_msgs__srv__move_periodic__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_periodic.MovePeriodic_Request", full_classname_dest, 57) == 0);
  }
  doosan_m0609_msgs__srv__MovePeriodic_Request * ros_message = _ros_message;
  {  // amp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_periodic__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MovePeriodic_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._move_periodic");
  ...
  doosan_m0609_msgs__srv__MovePeriodic_Request * ros_message = (doosan_m0609_msgs__srv__MovePeriodic_Request *)raw_ros_message;
  {  // amp
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool doosan_m0609_msgs__srv__move_periodic__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_periodic.MovePeriodic_Response", full_classname_dest, 58) == 0);
  }
  doosan_m0609_msgs__srv__MovePeriodic_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_periodic__response__convert_to_py(void * raw_ros_message)
{
  ...
  doosan_m0609_msgs__srv__MovePeriodic_Response * ros_message = (doosan_m0609_msgs__srv__MovePeriodic_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
