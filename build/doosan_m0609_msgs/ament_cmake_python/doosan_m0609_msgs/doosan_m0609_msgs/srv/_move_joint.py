...
class Metaclass_MoveJoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveJoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _move_joint
...
class MoveJoint(metaclass=Metaclass_MoveJoint):
    from doosan_m0609_msgs.srv._move_joint import MoveJoint_Request as Request
    from doosan_m0609_msgs.srv._move_joint import MoveJoint_Response as Response
