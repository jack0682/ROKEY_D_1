...
class Metaclass_GetCurrentToolFlangePosx(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetCurrentToolFlangePosx')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_current_tool_flange_posx
...
class GetCurrentToolFlangePosx(metaclass=Metaclass_GetCurrentToolFlangePosx):
    from doosan_m0609_msgs.srv._get_current_tool_flange_posx import GetCurrentToolFlangePosx_Request as Request
    from doosan_m0609_msgs.srv._get_current_tool_flange_posx import GetCurrentToolFlangePosx_Response as Response
