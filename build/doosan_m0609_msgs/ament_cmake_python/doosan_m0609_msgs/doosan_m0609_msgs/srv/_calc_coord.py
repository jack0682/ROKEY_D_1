...
class CalcCoord_Request(metaclass=Metaclass_CalcCoord_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'x4' not in kwargs:
            ...
            self.x4 = numpy.array(kwargs.get('x4'), dtype=numpy.float64)
            assert self.x4.shape == (6, )
...
class Metaclass_CalcCoord(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.CalcCoord')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _calc_coord
...
class CalcCoord(metaclass=Metaclass_CalcCoord):
    from doosan_m0609_msgs.srv._calc_coord import CalcCoord_Request as Request
    from doosan_m0609_msgs.srv._calc_coord import CalcCoord_Response as Response
