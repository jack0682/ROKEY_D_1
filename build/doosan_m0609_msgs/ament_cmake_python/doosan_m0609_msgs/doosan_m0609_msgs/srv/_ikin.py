...
class Ikin_Response(metaclass=Metaclass_Ikin_Response):
    ...
    def __init__(self, **kwargs):
        ...
        if 'conv_posj' not in kwargs:
            ...
            self.conv_posj = numpy.array(kwargs.get('conv_posj'), dtype=numpy.float64)
            assert self.conv_posj.shape == (6, )
...
class Metaclass_Ikin(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from doosan_m0609_msgs.srv import _ikin
...
class Ikin(metaclass=Metaclass_Ikin):
    from doosan_m0609_msgs.srv._ikin import Ikin_Request as Request
    from doosan_m0609_msgs.srv._ikin import Ikin_Response as Response
