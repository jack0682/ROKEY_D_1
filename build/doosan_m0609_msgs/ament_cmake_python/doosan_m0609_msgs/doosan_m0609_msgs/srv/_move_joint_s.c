...
bool doosan_m0609_msgs__srv__move_joint__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_joint.MoveJoint_Request", full_classname_dest, 51) == 0);
  }
  doosan_m0609_msgs__srv__MoveJoint_Request * ros_message = _ros_message;
  {  // pos
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_joint__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveJoint_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._move_joint");
  ...
  doosan_m0609_msgs__srv__MoveJoint_Request * ros_message = (doosan_m0609_msgs__srv__MoveJoint_Request *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool doosan_m0609_msgs__srv__move_joint__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_joint.MoveJoint_Response", full_classname_dest, 52) == 0);
  }
  doosan_m0609_msgs__srv__MoveJoint_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_joint__response__convert_to_py(void * raw_ros_message)
{
  ...
  doosan_m0609_msgs__srv__MoveJoint_Response * ros_message = (doosan_m0609_msgs__srv__MoveJoint_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
