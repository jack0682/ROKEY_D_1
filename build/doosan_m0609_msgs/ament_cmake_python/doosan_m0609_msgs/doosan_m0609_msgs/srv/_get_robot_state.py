...
class Metaclass_GetRobotState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetRobotState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_robot_state
...
class GetRobotState(metaclass=Metaclass_GetRobotState):
    from doosan_m0609_msgs.srv._get_robot_state import GetRobotState_Request as Request
    from doosan_m0609_msgs.srv._get_robot_state import GetRobotState_Response as Response
