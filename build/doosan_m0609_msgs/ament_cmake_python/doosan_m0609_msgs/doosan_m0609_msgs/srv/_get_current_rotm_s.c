...
bool doosan_m0609_msgs__srv__get_current_rotm__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._get_current_rotm.GetCurrentRotm_Request", full_classname_dest, 62) == 0);
  }
  doosan_m0609_msgs__srv__GetCurrentRotm_Request * ros_message = _ros_message;
  {  // ref
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__get_current_rotm__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GetCurrentRotm_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._get_current_rotm");
  ...
  doosan_m0609_msgs__srv__GetCurrentRotm_Request * ros_message = (doosan_m0609_msgs__srv__GetCurrentRotm_Request *)raw_ros_message;
  {  // ref
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool doosan_m0609_msgs__srv__get_current_rotm__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._get_current_rotm.GetCurrentRotm_Response", full_classname_dest, 63) == 0);
  }
  doosan_m0609_msgs__srv__GetCurrentRotm_Response * ros_message = _ros_message;
  {  // rot_matrix
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__get_current_rotm__response__convert_to_py(void * raw_ros_message)
{
  ...
  doosan_m0609_msgs__srv__GetCurrentRotm_Response * ros_message = (doosan_m0609_msgs__srv__GetCurrentRotm_Response *)raw_ros_message;
  {  // rot_matrix
    PyObject * field = NULL;
