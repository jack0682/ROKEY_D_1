...
bool doosan_m0609_msgs__srv__move_circle__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_circle.MoveCircle_Request", full_classname_dest, 53) == 0);
  }
  doosan_m0609_msgs__srv__MoveCircle_Request * ros_message = _ros_message;
  {  // pos
  ...
  {  // angle1
    ...
    assert(PyFloat_Check(field));
    ros_message->angle1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // angle2
    ...
    assert(PyFloat_Check(field));
    ros_message->angle2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // blend_type
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_circle__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveCircle_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._move_circle");
  ...
  doosan_m0609_msgs__srv__MoveCircle_Request * ros_message = (doosan_m0609_msgs__srv__MoveCircle_Request *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool doosan_m0609_msgs__srv__move_circle__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_circle.MoveCircle_Response", full_classname_dest, 54) == 0);
  }
  doosan_m0609_msgs__srv__MoveCircle_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_circle__response__convert_to_py(void * raw_ros_message)
{
  ...
  doosan_m0609_msgs__srv__MoveCircle_Response * ros_message = (doosan_m0609_msgs__srv__MoveCircle_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
