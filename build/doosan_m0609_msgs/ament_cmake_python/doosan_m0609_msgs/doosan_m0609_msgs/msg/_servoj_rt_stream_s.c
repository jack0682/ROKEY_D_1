...
bool doosan_m0609_msgs__msg__servoj_rt_stream__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.msg._servoj_rt_stream.ServojRtStream", full_classname_dest, 54) == 0);
  }
  doosan_m0609_msgs__msg__ServojRtStream * ros_message = _ros_message;
  {  // pos
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__msg__servoj_rt_stream__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ServojRtStream */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.msg._servoj_rt_stream");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServojRtStream");
  ...
  doosan_m0609_msgs__msg__ServojRtStream * ros_message = (doosan_m0609_msgs__msg__ServojRtStream *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
