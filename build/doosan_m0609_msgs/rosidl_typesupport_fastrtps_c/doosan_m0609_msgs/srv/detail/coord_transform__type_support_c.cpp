...
#include "doosan_m0609_msgs/srv/detail/coord_transform__rosidl_typesupport_fastrtps_c.h"
...
using _CoordTransform_Request__ros_msg_type = doosan_m0609_msgs__srv__CoordTransform_Request;
...
size_t get_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Request(
  const void * untyped_ros_message,
...
static uint32_t _CoordTransform_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs__srv__CoordTransform_Request;
    is_plain =
      (
...
static size_t _CoordTransform_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, CoordTransform_Request)() {
...
using _CoordTransform_Response__ros_msg_type = doosan_m0609_msgs__srv__CoordTransform_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t get_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CoordTransform_Response__ros_msg_type * ros_message = static_cast<const _CoordTransform_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = doosan_m0609_msgs__srv__CoordTransform_Response;
    is_plain =
      (
...
static size_t _CoordTransform_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__srv__CoordTransform_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, CoordTransform_Response)() {
...
// already included above
// #include "doosan_m0609_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "doosan_m0609_msgs/srv/coord_transform.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, CoordTransform)() {
