...
#include "doosan_m0609_msgs/srv/detail/set_safety_mode__rosidl_typesupport_fastrtps_c.h"
...
using _SetSafetyMode_Request__ros_msg_type = doosan_m0609_msgs__srv__SetSafetyMode_Request;
...
size_t get_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetSafetyMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs__srv__SetSafetyMode_Request;
    is_plain =
      (
...
static size_t _SetSafetyMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetSafetyMode_Request)() {
...
using _SetSafetyMode_Response__ros_msg_type = doosan_m0609_msgs__srv__SetSafetyMode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t get_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetSafetyMode_Response__ros_msg_type * ros_message = static_cast<const _SetSafetyMode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = doosan_m0609_msgs__srv__SetSafetyMode_Response;
    is_plain =
      (
...
static size_t _SetSafetyMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__srv__SetSafetyMode_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetSafetyMode_Response)() {
...
// already included above
// #include "doosan_m0609_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "doosan_m0609_msgs/srv/set_safety_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetSafetyMode)() {
