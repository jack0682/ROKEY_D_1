...
#include "doosan_m0609_msgs/msg/detail/alter_motion_stream__rosidl_typesupport_fastrtps_c.h"
...
using _AlterMotionStream__ros_msg_type = doosan_m0609_msgs__msg__AlterMotionStream;
...
size_t get_serialized_size_doosan_m0609_msgs__msg__AlterMotionStream(
  const void * untyped_ros_message,
...
static uint32_t _AlterMotionStream__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__msg__AlterMotionStream(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__msg__AlterMotionStream(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs__msg__AlterMotionStream;
    is_plain =
      (
...
static size_t _AlterMotionStream__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__msg__AlterMotionStream(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, msg, AlterMotionStream)() {
