...
#include "doosan_m0609_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
#include "doosan_m0609_msgs/msg/detail/modbus_state__functions.h"  // modbus_state
...
using _RobotState__ros_msg_type = doosan_m0609_msgs__msg__RobotState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: modbus_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, msg, ModbusState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: modbus_state
  {
    ...
    if (ros_message->modbus_state.data) {
      doosan_m0609_msgs__msg__ModbusState__Sequence__fini(&ros_message->modbus_state);
    }
    if (!doosan_m0609_msgs__msg__ModbusState__Sequence__init(&ros_message->modbus_state, size)) {
...
size_t get_serialized_size_doosan_m0609_msgs__msg__RobotState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotState__ros_msg_type * ros_message = static_cast<const _RobotState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name modbus_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_doosan_m0609_msgs__msg__ModbusState(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name access_control
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__msg__RobotState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_doosan_m0609_msgs
size_t max_serialized_size_doosan_m0609_msgs__msg__RobotState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: modbus_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_doosan_m0609_msgs__msg__ModbusState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs__msg__RobotState;
    is_plain =
      (
...
static size_t _RobotState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__msg__RobotState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, msg, RobotState)() {
