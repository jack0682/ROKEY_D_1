...
#include "doosan_m0609_msgs/msg/detail/robot_state_rt__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStateRt__ros_msg_type = doosan_m0609_msgs__msg__RobotStateRt;
...
static uint32_t _RobotStateRt__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_msgs__msg__RobotStateRt(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs__msg__RobotStateRt;
    is_plain =
      (
...
static size_t _RobotStateRt__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_msgs__msg__RobotStateRt(
