...
#include "doosan_m0609_msgs/srv/detail/coord_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_m0609_msgs::srv::CoordTransform_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::CoordTransform_Request & ros_message)
{
  // Member: pos_in
  {
    cdr >> ros_message.pos_in;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::srv::CoordTransform_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::CoordTransform_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::CoordTransform_Request *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, CoordTransform_Request)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_doosan_m0609_msgs
cdr_serialize(
  const doosan_m0609_msgs::srv::CoordTransform_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: conv_posx
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::CoordTransform_Response & ros_message)
{
  // Member: conv_posx
  {
    cdr >> ros_message.conv_posx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = doosan_m0609_msgs::srv::CoordTransform_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::CoordTransform_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::CoordTransform_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, CoordTransform_Response)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform_Response__handle;
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, CoordTransform)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_CoordTransform__handle;
}
