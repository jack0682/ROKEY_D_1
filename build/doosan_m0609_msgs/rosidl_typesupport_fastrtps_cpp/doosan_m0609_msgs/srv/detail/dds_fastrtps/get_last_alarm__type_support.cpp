...
#include "doosan_m0609_msgs/srv/detail/get_last_alarm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_m0609_msgs::srv::GetLastAlarm_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::GetLastAlarm_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::srv::GetLastAlarm_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::GetLastAlarm_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::GetLastAlarm_Request *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetLastAlarm_Request)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm_Request__handle;
}
...
{
bool cdr_serialize(
  const doosan_m0609_msgs::msg::LogAlarm &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  doosan_m0609_msgs::msg::LogAlarm &);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_doosan_m0609_msgs
cdr_serialize(
  const doosan_m0609_msgs::srv::GetLastAlarm_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: log_alarm
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::GetLastAlarm_Response & ros_message)
{
  // Member: log_alarm
  ...
  size_t current_alignment)
{
  ...
  // Member: log_alarm
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LogAlarm(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = doosan_m0609_msgs::srv::GetLastAlarm_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::GetLastAlarm_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::GetLastAlarm_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetLastAlarm_Response)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm_Response__handle;
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetLastAlarm)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetLastAlarm__handle;
}
