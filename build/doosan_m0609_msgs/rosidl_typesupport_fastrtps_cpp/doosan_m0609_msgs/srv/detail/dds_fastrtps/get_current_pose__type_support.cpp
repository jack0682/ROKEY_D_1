...
#include "doosan_m0609_msgs/srv/detail/get_current_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_m0609_msgs::srv::GetCurrentPose_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: space_type
  cdr << ros_message.space_type;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::GetCurrentPose_Request & ros_message)
{
  // Member: space_type
  cdr >> ros_message.space_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: space_type
  {
    size_t item_size = sizeof(ros_message.space_type);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::srv::GetCurrentPose_Request;
    is_plain =
      (
      offsetof(DataType, space_type) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::GetCurrentPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::GetCurrentPose_Request *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetCurrentPose_Request)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_doosan_m0609_msgs
cdr_serialize(
  const doosan_m0609_msgs::srv::GetCurrentPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pos
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::srv::GetCurrentPose_Response & ros_message)
{
  // Member: pos
  {
    cdr >> ros_message.pos;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = doosan_m0609_msgs::srv::GetCurrentPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::srv::GetCurrentPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::srv::GetCurrentPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetCurrentPose_Response)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Response__handle;
}
...
{
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetCurrentPose)() {
  return &doosan_m0609_msgs::srv::typesupport_fastrtps_cpp::_GetCurrentPose__handle;
}
