...
#include "doosan_m0609_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const doosan_m0609_msgs::msg::ModbusState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const doosan_m0609_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::msg::RobotState & ros_message)
{
  // Member: robot_state
  cdr >> ros_message.robot_state;
  ...
  size_t current_alignment)
{
  ...
  // Member: modbus_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ModbusState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, msg, RobotState)() {
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
