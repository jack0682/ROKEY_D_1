...
#include "doosan_m0609_msgs/msg/detail/servol_rt_stream__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_m0609_msgs::msg::ServolRtStream & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::msg::ServolRtStream & ros_message)
{
  // Member: pos
  {
    cdr >> ros_message.pos;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::msg::ServolRtStream;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::msg::ServolRtStream *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::msg::ServolRtStream *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_ServolRtStream__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, msg, ServolRtStream)() {
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_ServolRtStream__handle;
}
