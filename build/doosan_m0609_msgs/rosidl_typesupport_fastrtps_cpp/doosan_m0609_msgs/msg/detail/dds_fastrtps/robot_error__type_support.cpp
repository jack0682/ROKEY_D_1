...
#include "doosan_m0609_msgs/msg/detail/robot_error__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doosan_m0609_msgs::msg::RobotError & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doosan_m0609_msgs::msg::RobotError & ros_message)
{
  // Member: level
  cdr >> ros_message.level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_msgs::msg::RobotError;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const doosan_m0609_msgs::msg::RobotError *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doosan_m0609_msgs::msg::RobotError *>(
    untyped_ros_message);
...
{
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_RobotError__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, msg, RobotError)() {
  return &doosan_m0609_msgs::msg::typesupport_fastrtps_cpp::_RobotError__handle;
}
