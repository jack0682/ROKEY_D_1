...
{
  new (message_memory) doosan_m0609_msgs::srv::GetDesiredVelx_Request(_init);
}

void GetDesiredVelx_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::srv::GetDesiredVelx_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetDesiredVelx_Request_message_member_array[1] = {
  {
    ...
    offsetof(doosan_m0609_msgs::srv::GetDesiredVelx_Request, ref),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetDesiredVelx_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(doosan_m0609_msgs::srv::GetDesiredVelx_Request),
...
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::GetDesiredVelx_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetDesiredVelx_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::GetDesiredVelx_Request_message_type_support_handle;
}
...
void GetDesiredVelx_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) doosan_m0609_msgs::srv::GetDesiredVelx_Response(_init);
}

void GetDesiredVelx_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::srv::GetDesiredVelx_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetDesiredVelx_Response_message_member_array[2] = {
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::GetDesiredVelx_Response, vel),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::GetDesiredVelx_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetDesiredVelx_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(doosan_m0609_msgs::srv::GetDesiredVelx_Response),
...
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::GetDesiredVelx_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetDesiredVelx_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::GetDesiredVelx_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetDesiredVelx_service_members = {
  ...
  // see get_service_type_support_handle<doosan_m0609_msgs::srv::GetDesiredVelx>()
...
get_service_type_support_handle<doosan_m0609_msgs::srv::GetDesiredVelx>()
{
  ...
  auto service_type_support =
    &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::GetDesiredVelx_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetDesiredVelx)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<doosan_m0609_msgs::srv::GetDesiredVelx>();
}
