...
static const _RobotDisconnection_type_support_symbol_names_t _RobotDisconnection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, msg, RobotDisconnection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, msg, RobotDisconnection)),
  }
};
...
{
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_cpp::RobotDisconnection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_m0609_msgs, msg, RobotDisconnection)() {
  return get_message_type_support_handle<doosan_m0609_msgs::msg::RobotDisconnection>();
}
