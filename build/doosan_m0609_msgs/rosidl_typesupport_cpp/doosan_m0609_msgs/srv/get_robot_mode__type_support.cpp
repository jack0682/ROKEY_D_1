...
static const _GetRobotMode_Request_type_support_symbol_names_t _GetRobotMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetRobotMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetRobotMode_Request)),
  }
};
...
get_message_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode_Request>()
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_cpp::GetRobotMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_m0609_msgs, srv, GetRobotMode_Request)() {
  return get_message_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode_Request>();
}
...
static const _GetRobotMode_Response_type_support_symbol_names_t _GetRobotMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetRobotMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetRobotMode_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode_Response>()
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_cpp::GetRobotMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_m0609_msgs, srv, GetRobotMode_Response)() {
  return get_message_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode_Response>();
}
...
static const _GetRobotMode_type_support_symbol_names_t _GetRobotMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doosan_m0609_msgs, srv, GetRobotMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, GetRobotMode)),
  }
};
...
get_service_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode>()
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_cpp::GetRobotMode_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, doosan_m0609_msgs, srv, GetRobotMode)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<doosan_m0609_msgs::srv::GetRobotMode>();
}
