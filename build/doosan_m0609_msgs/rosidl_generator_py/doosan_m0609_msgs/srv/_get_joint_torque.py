...
class GetJointTorque_Response(metaclass=Metaclass_GetJointTorque_Response):
    ...
    def __init__(self, **kwargs):
        ...
        if 'jts' not in kwargs:
            ...
            self.jts = numpy.array(kwargs.get('jts'), dtype=numpy.float64)
            assert self.jts.shape == (6, )
...
class Metaclass_GetJointTorque(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetJointTorque')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_joint_torque
...
class GetJointTorque(metaclass=Metaclass_GetJointTorque):
    from doosan_m0609_msgs.srv._get_joint_torque import GetJointTorque_Request as Request
    from doosan_m0609_msgs.srv._get_joint_torque import GetJointTorque_Response as Response
