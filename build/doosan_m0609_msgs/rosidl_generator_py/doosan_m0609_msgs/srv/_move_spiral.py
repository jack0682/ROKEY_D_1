...
class Metaclass_MoveSpiral(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveSpiral')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _move_spiral
...
class MoveSpiral(metaclass=Metaclass_MoveSpiral):
    from doosan_m0609_msgs.srv._move_spiral import MoveSpiral_Request as Request
    from doosan_m0609_msgs.srv._move_spiral import MoveSpiral_Response as Response
