...
class Metaclass_ReleaseForce(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.ReleaseForce')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _release_force
...
class ReleaseForce(metaclass=Metaclass_ReleaseForce):
    from doosan_m0609_msgs.srv._release_force import ReleaseForce_Request as Request
    from doosan_m0609_msgs.srv._release_force import ReleaseForce_Response as Response
