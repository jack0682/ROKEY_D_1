...
class Metaclass_SetSafeStopResetType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetSafeStopResetType')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _set_safe_stop_reset_type
...
class SetSafeStopResetType(metaclass=Metaclass_SetSafeStopResetType):
    from doosan_m0609_msgs.srv._set_safe_stop_reset_type import SetSafeStopResetType_Request as Request
    from doosan_m0609_msgs.srv._set_safe_stop_reset_type import SetSafeStopResetType_Response as Response
