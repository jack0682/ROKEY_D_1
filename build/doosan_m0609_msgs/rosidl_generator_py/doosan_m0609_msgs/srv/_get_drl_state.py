...
class Metaclass_GetDrlState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetDrlState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_drl_state
...
class GetDrlState(metaclass=Metaclass_GetDrlState):
    from doosan_m0609_msgs.srv._get_drl_state import GetDrlState_Request as Request
    from doosan_m0609_msgs.srv._get_drl_state import GetDrlState_Response as Response
