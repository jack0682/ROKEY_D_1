...
class Metaclass_SetRtControlInput(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetRtControlInput')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _set_rt_control_input
...
class SetRtControlInput(metaclass=Metaclass_SetRtControlInput):
    from doosan_m0609_msgs.srv._set_rt_control_input import SetRtControlInput_Request as Request
    from doosan_m0609_msgs.srv._set_rt_control_input import SetRtControlInput_Response as Response
