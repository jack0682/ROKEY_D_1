...
class Metaclass_GetRtControlInputVersionList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetRtControlInputVersionList')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_rt_control_input_version_list
...
class GetRtControlInputVersionList(metaclass=Metaclass_GetRtControlInputVersionList):
    from doosan_m0609_msgs.srv._get_rt_control_input_version_list import GetRtControlInputVersionList_Request as Request
    from doosan_m0609_msgs.srv._get_rt_control_input_version_list import GetRtControlInputVersionList_Response as Response
