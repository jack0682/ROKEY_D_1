    ...
    def robot_mode(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'robot_mode' field must be an integer in [-128, 127]"
...
class Metaclass_SetRobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetRobotMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _set_robot_mode
...
class SetRobotMode(metaclass=Metaclass_SetRobotMode):
    from doosan_m0609_msgs.srv._set_robot_mode import SetRobotMode_Request as Request
    from doosan_m0609_msgs.srv._set_robot_mode import SetRobotMode_Response as Response
