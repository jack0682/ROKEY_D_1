...
class Metaclass_MoveJointx(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveJointx')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _move_jointx
...
class MoveJointx(metaclass=Metaclass_MoveJointx):
    from doosan_m0609_msgs.srv._move_jointx import MoveJointx_Request as Request
    from doosan_m0609_msgs.srv._move_jointx import MoveJointx_Response as Response
