...
class Metaclass_MoveSplineTask_Request(type):
    """Metaclass of message 'MoveSplineTask_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_spline_task__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_spline_task__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_spline_task__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_spline_task__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_spline_task__request
...
class MoveSplineTask_Request(metaclass=Metaclass_MoveSplineTask_Request):
    """Message class 'MoveSplineTask_Request'."""
    ...
    def opt(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'opt' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'opt' field must be an integer in [-128, 127]"
        self._opt = value
...
class Metaclass_MoveSplineTask_Response(type):
    """Metaclass of message 'MoveSplineTask_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_spline_task__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_spline_task__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_spline_task__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_spline_task__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_spline_task__response
...
class MoveSplineTask_Response(metaclass=Metaclass_MoveSplineTask_Response):
    """Message class 'MoveSplineTask_Response'."""
...
class Metaclass_MoveSplineTask(type):
    """Metaclass of service 'MoveSplineTask'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveSplineTask')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__move_spline_task

            from doosan_m0609_msgs.srv import _move_spline_task
            if _move_spline_task.Metaclass_MoveSplineTask_Request._TYPE_SUPPORT is None:
                _move_spline_task.Metaclass_MoveSplineTask_Request.__import_type_support__()
            if _move_spline_task.Metaclass_MoveSplineTask_Response._TYPE_SUPPORT is None:
                _move_spline_task.Metaclass_MoveSplineTask_Response.__import_type_support__()


class MoveSplineTask(metaclass=Metaclass_MoveSplineTask):
    from doosan_m0609_msgs.srv._move_spline_task import MoveSplineTask_Request as Request
    from doosan_m0609_msgs.srv._move_spline_task import MoveSplineTask_Response as Response
