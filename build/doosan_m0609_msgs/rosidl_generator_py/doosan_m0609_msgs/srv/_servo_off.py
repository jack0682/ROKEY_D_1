...
class Metaclass_ServoOff(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.ServoOff')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _servo_off
...
class ServoOff(metaclass=Metaclass_ServoOff):
    from doosan_m0609_msgs.srv._servo_off import ServoOff_Request as Request
    from doosan_m0609_msgs.srv._servo_off import ServoOff_Response as Response
