...
bool doosan_m0609_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.msg._robot_state.RobotState", full_classname_dest, 45) == 0);
  }
  doosan_m0609_msgs__msg__RobotState * ros_message = _ros_message;
  {  // robot_state
  ...
  {  // modbus_state
    ...
    if (!doosan_m0609_msgs__msg__ModbusState__Sequence__init(&(ros_message->modbus_state), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create doosan_m0609_msgs__msg__ModbusState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    doosan_m0609_msgs__msg__ModbusState * dest = ros_message->modbus_state.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!doosan_m0609_msgs__msg__modbus_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RobotState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.msg._robot_state");
  ...
  doosan_m0609_msgs__msg__RobotState * ros_message = (doosan_m0609_msgs__msg__RobotState *)raw_ros_message;
  {  // robot_state
    PyObject * field = NULL;
  ...
  {  // modbus_state
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = doosan_m0609_msgs__msg__modbus_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
