...
bool doosan_m0609_msgs__msg__robot_state_rt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.msg._robot_state_rt.RobotStateRt", full_classname_dest, 50) == 0);
  }
  doosan_m0609_msgs__msg__RobotStateRt * ros_message = _ros_message;
  {  // time_stamp
...
PyObject * doosan_m0609_msgs__msg__robot_state_rt__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.msg._robot_state_rt");
  ...
  doosan_m0609_msgs__msg__RobotStateRt * ros_message = (doosan_m0609_msgs__msg__RobotStateRt *)raw_ros_message;
  {  // time_stamp
    PyObject * field = NULL;
