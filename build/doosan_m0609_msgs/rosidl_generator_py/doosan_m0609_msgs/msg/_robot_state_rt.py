    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'doosan_m0609_msgs.msg.RobotStateRt')
            logger.debug(
...
class RobotStateRt(metaclass=Metaclass_RobotStateRt):
    ...
    def __init__(self, **kwargs):
        ...
        if 'actual_joint_position' not in kwargs:
            ...
            self.actual_joint_position = numpy.array(kwargs.get('actual_joint_position'), dtype=numpy.float64)
            assert self.actual_joint_position.shape == (6, )
        if 'actual_joint_position_abs' not in kwargs:
            self.actual_joint_position_abs = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_joint_position_abs = numpy.array(kwargs.get('actual_joint_position_abs'), dtype=numpy.float64)
            assert self.actual_joint_position_abs.shape == (6, )
        if 'actual_joint_velocity' not in kwargs:
            self.actual_joint_velocity = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_joint_velocity = numpy.array(kwargs.get('actual_joint_velocity'), dtype=numpy.float64)
            assert self.actual_joint_velocity.shape == (6, )
        if 'actual_joint_velocity_abs' not in kwargs:
            self.actual_joint_velocity_abs = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_joint_velocity_abs = numpy.array(kwargs.get('actual_joint_velocity_abs'), dtype=numpy.float64)
            assert self.actual_joint_velocity_abs.shape == (6, )
        if 'actual_tcp_position' not in kwargs:
            self.actual_tcp_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_tcp_position = numpy.array(kwargs.get('actual_tcp_position'), dtype=numpy.float64)
            assert self.actual_tcp_position.shape == (6, )
        if 'actual_tcp_velocity' not in kwargs:
            self.actual_tcp_velocity = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_tcp_velocity = numpy.array(kwargs.get('actual_tcp_velocity'), dtype=numpy.float64)
            assert self.actual_tcp_velocity.shape == (6, )
        if 'actual_flange_position' not in kwargs:
            self.actual_flange_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_flange_position = numpy.array(kwargs.get('actual_flange_position'), dtype=numpy.float64)
            assert self.actual_flange_position.shape == (6, )
        if 'actual_flange_velocity' not in kwargs:
            self.actual_flange_velocity = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_flange_velocity = numpy.array(kwargs.get('actual_flange_velocity'), dtype=numpy.float64)
            assert self.actual_flange_velocity.shape == (6, )
        if 'actual_motor_torque' not in kwargs:
            self.actual_motor_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_motor_torque = numpy.array(kwargs.get('actual_motor_torque'), dtype=numpy.float64)
            assert self.actual_motor_torque.shape == (6, )
        if 'actual_joint_torque' not in kwargs:
            self.actual_joint_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.actual_joint_torque = numpy.array(kwargs.get('actual_joint_torque'), dtype=numpy.float64)
            assert self.actual_joint_torque.shape == (6, )
        if 'raw_joint_torque' not in kwargs:
            self.raw_joint_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.raw_joint_torque = numpy.array(kwargs.get('raw_joint_torque'), dtype=numpy.float64)
            assert self.raw_joint_torque.shape == (6, )
        if 'raw_force_torque' not in kwargs:
            self.raw_force_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.raw_force_torque = numpy.array(kwargs.get('raw_force_torque'), dtype=numpy.float64)
            assert self.raw_force_torque.shape == (6, )
        if 'external_joint_torque' not in kwargs:
            self.external_joint_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.external_joint_torque = numpy.array(kwargs.get('external_joint_torque'), dtype=numpy.float64)
            assert self.external_joint_torque.shape == (6, )
        if 'external_tcp_force' not in kwargs:
            self.external_tcp_force = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.external_tcp_force = numpy.array(kwargs.get('external_tcp_force'), dtype=numpy.float64)
            assert self.external_tcp_force.shape == (6, )
        if 'target_joint_position' not in kwargs:
            self.target_joint_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_joint_position = numpy.array(kwargs.get('target_joint_position'), dtype=numpy.float64)
            assert self.target_joint_position.shape == (6, )
        if 'target_joint_velocity' not in kwargs:
            self.target_joint_velocity = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_joint_velocity = numpy.array(kwargs.get('target_joint_velocity'), dtype=numpy.float64)
            assert self.target_joint_velocity.shape == (6, )
        if 'target_joint_acceleration' not in kwargs:
            self.target_joint_acceleration = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_joint_acceleration = numpy.array(kwargs.get('target_joint_acceleration'), dtype=numpy.float64)
            assert self.target_joint_acceleration.shape == (6, )
        if 'target_motor_torque' not in kwargs:
            self.target_motor_torque = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_motor_torque = numpy.array(kwargs.get('target_motor_torque'), dtype=numpy.float64)
            assert self.target_motor_torque.shape == (6, )
        if 'target_tcp_position' not in kwargs:
            self.target_tcp_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_tcp_position = numpy.array(kwargs.get('target_tcp_position'), dtype=numpy.float64)
            assert self.target_tcp_position.shape == (6, )
        if 'target_tcp_velocity' not in kwargs:
            self.target_tcp_velocity = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.target_tcp_velocity = numpy.array(kwargs.get('target_tcp_velocity'), dtype=numpy.float64)
            assert self.target_tcp_velocity.shape == (6, )
        ...
        if 'gravity_torque' not in kwargs:
            ...
            self.gravity_torque = numpy.array(kwargs.get('gravity_torque'), dtype=numpy.float64)
            assert self.gravity_torque.shape == (6, )
        ...
        if 'joint_temperature' not in kwargs:
            ...
            assert self.joint_temperature.shape == (6, )
        ...
        if 'controller_analog_input_type' not in kwargs:
            ...
            self.controller_analog_input_type = numpy.array(kwargs.get('controller_analog_input_type'), dtype=numpy.uint8)
            assert self.controller_analog_input_type.shape == (2, )
        if 'controller_analog_input' not in kwargs:
            self.controller_analog_input = numpy.zeros(2, dtype=numpy.float64)
        else:
            self.controller_analog_input = numpy.array(kwargs.get('controller_analog_input'), dtype=numpy.float64)
            assert self.controller_analog_input.shape == (2, )
        if 'controller_analog_output_type' not in kwargs:
            self.controller_analog_output_type = numpy.zeros(2, dtype=numpy.uint8)
        else:
            self.controller_analog_output_type = numpy.array(kwargs.get('controller_analog_output_type'), dtype=numpy.uint8)
            assert self.controller_analog_output_type.shape == (2, )
        if 'controller_analog_output' not in kwargs:
            self.controller_analog_output = numpy.zeros(2, dtype=numpy.float64)
        else:
            self.controller_analog_output = numpy.array(kwargs.get('controller_analog_output'), dtype=numpy.float64)
            assert self.controller_analog_output.shape == (2, )
        ...
        if 'flange_analog_input' not in kwargs:
            ...
            self.flange_analog_input = numpy.array(kwargs.get('flange_analog_input'), dtype=numpy.float64)
            assert self.flange_analog_input.shape == (4, )
        if 'external_encoder_strobe_count' not in kwargs:
            self.external_encoder_strobe_count = numpy.zeros(2, dtype=numpy.uint8)
        else:
            self.external_encoder_strobe_count = numpy.array(kwargs.get('external_encoder_strobe_count'), dtype=numpy.uint8)
            assert self.external_encoder_strobe_count.shape == (2, )
        if 'external_encoder_count' not in kwargs:
            self.external_encoder_count = numpy.zeros(2, dtype=numpy.uint16)
        else:
            self.external_encoder_count = numpy.array(kwargs.get('external_encoder_count'), dtype=numpy.uint16)
            assert self.external_encoder_count.shape == (2, )
        if 'goal_joint_position' not in kwargs:
            self.goal_joint_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.goal_joint_position = numpy.array(kwargs.get('goal_joint_position'), dtype=numpy.float64)
            assert self.goal_joint_position.shape == (6, )
        if 'goal_tcp_position' not in kwargs:
            self.goal_tcp_position = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.goal_tcp_position = numpy.array(kwargs.get('goal_tcp_position'), dtype=numpy.float64)
            assert self.goal_tcp_position.shape == (6, )
        ...
        if 'reserved' not in kwargs:
            ...
            self.reserved = numpy.array(kwargs.get('reserved'), dtype=numpy.uint8)
            assert self.reserved.shape == (256, )
