...
#include "doosan_m0609_msgs/msg/detail/servol_stream__type_support.h"
...
static const _ServolStream_type_support_symbol_names_t _ServolStream_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, msg, ServolStream)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, msg, ServolStream)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, msg, ServolStream)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_c::ServolStream_message_type_support_handle;
}
