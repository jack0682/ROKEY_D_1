...
#include "doosan_m0609_msgs/msg/detail/torque_rt_stream__type_support.h"
...
static const _TorqueRtStream_type_support_symbol_names_t _TorqueRtStream_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, msg, TorqueRtStream)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, msg, TorqueRtStream)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, msg, TorqueRtStream)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_c::TorqueRtStream_message_type_support_handle;
}
