...
#include "doosan_m0609_msgs/srv/detail/move_line__type_support.h"
...
static const _MoveLine_Request_type_support_symbol_names_t _MoveLine_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, MoveLine_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, MoveLine_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, MoveLine_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::MoveLine_Request_message_type_support_handle;
}
...
static const _MoveLine_Response_type_support_symbol_names_t _MoveLine_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, MoveLine_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, MoveLine_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, MoveLine_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::MoveLine_Response_message_type_support_handle;
}
...
static const _MoveLine_type_support_symbol_names_t _MoveLine_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, MoveLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, MoveLine)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, MoveLine)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::MoveLine_service_type_support_handle;
}
