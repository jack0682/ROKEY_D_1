...
#include "doosan_m0609_msgs/srv/detail/get_modbus_input__type_support.h"
...
static const _GetModbusInput_Request_type_support_symbol_names_t _GetModbusInput_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetModbusInput_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetModbusInput_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetModbusInput_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetModbusInput_Request_message_type_support_handle;
}
...
static const _GetModbusInput_Response_type_support_symbol_names_t _GetModbusInput_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetModbusInput_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetModbusInput_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetModbusInput_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetModbusInput_Response_message_type_support_handle;
}
...
static const _GetModbusInput_type_support_symbol_names_t _GetModbusInput_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetModbusInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetModbusInput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetModbusInput)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetModbusInput_service_type_support_handle;
}
