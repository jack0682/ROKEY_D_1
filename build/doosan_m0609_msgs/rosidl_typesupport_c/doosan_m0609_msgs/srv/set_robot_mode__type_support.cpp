...
#include "doosan_m0609_msgs/srv/detail/set_robot_mode__type_support.h"
...
static const _SetRobotMode_Request_type_support_symbol_names_t _SetRobotMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetRobotMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, SetRobotMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, SetRobotMode_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::SetRobotMode_Request_message_type_support_handle;
}
...
static const _SetRobotMode_Response_type_support_symbol_names_t _SetRobotMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetRobotMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, SetRobotMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, SetRobotMode_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::SetRobotMode_Response_message_type_support_handle;
}
...
static const _SetRobotMode_type_support_symbol_names_t _SetRobotMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, SetRobotMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, SetRobotMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, SetRobotMode)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::SetRobotMode_service_type_support_handle;
}
