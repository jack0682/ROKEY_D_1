...
#include "doosan_m0609_msgs/srv/detail/get_tool_digital_output__type_support.h"
...
static const _GetToolDigitalOutput_Request_type_support_symbol_names_t _GetToolDigitalOutput_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetToolDigitalOutput_Request_message_type_support_handle;
}
...
static const _GetToolDigitalOutput_Response_type_support_symbol_names_t _GetToolDigitalOutput_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetToolDigitalOutput_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetToolDigitalOutput_Response_message_type_support_handle;
}
...
static const _GetToolDigitalOutput_type_support_symbol_names_t _GetToolDigitalOutput_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_msgs, srv, GetToolDigitalOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_msgs, srv, GetToolDigitalOutput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_msgs, srv, GetToolDigitalOutput)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_c::GetToolDigitalOutput_service_type_support_handle;
}
