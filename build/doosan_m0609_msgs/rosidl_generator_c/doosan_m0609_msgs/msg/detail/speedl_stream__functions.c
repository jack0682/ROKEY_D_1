...
doosan_m0609_msgs__msg__SpeedlStream__create()
{
  ...
  doosan_m0609_msgs__msg__SpeedlStream * msg = (doosan_m0609_msgs__msg__SpeedlStream *)allocator.allocate(sizeof(doosan_m0609_msgs__msg__SpeedlStream), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(doosan_m0609_msgs__msg__SpeedlStream));
  bool success = doosan_m0609_msgs__msg__SpeedlStream__init(msg);
  if (!success) {
...
doosan_m0609_msgs__msg__SpeedlStream__destroy(doosan_m0609_msgs__msg__SpeedlStream * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    doosan_m0609_msgs__msg__SpeedlStream__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
doosan_m0609_msgs__msg__SpeedlStream__Sequence__init(doosan_m0609_msgs__msg__SpeedlStream__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  doosan_m0609_msgs__msg__SpeedlStream * data = NULL;

  if (size) {
    data = (doosan_m0609_msgs__msg__SpeedlStream *)allocator.zero_allocate(size, sizeof(doosan_m0609_msgs__msg__SpeedlStream), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = doosan_m0609_msgs__msg__SpeedlStream__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        doosan_m0609_msgs__msg__SpeedlStream__fini(&data[i - 1]);
      }
...
doosan_m0609_msgs__msg__SpeedlStream__Sequence__fini(doosan_m0609_msgs__msg__SpeedlStream__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      doosan_m0609_msgs__msg__SpeedlStream__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  doosan_m0609_msgs__msg__SpeedlStream__Sequence * array = (doosan_m0609_msgs__msg__SpeedlStream__Sequence *)allocator.allocate(sizeof(doosan_m0609_msgs__msg__SpeedlStream__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = doosan_m0609_msgs__msg__SpeedlStream__Sequence__init(array, size);
  if (!success) {
...
doosan_m0609_msgs__msg__SpeedlStream__Sequence__destroy(doosan_m0609_msgs__msg__SpeedlStream__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    doosan_m0609_msgs__msg__SpeedlStream__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
doosan_m0609_msgs__msg__SpeedlStream__Sequence__are_equal(const doosan_m0609_msgs__msg__SpeedlStream__Sequence * lhs, const doosan_m0609_msgs__msg__SpeedlStream__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!doosan_m0609_msgs__msg__SpeedlStream__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  doosan_m0609_msgs__msg__SpeedlStream__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(doosan_m0609_msgs__msg__SpeedlStream);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    doosan_m0609_msgs__msg__SpeedlStream * data =
      (doosan_m0609_msgs__msg__SpeedlStream *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!doosan_m0609_msgs__msg__SpeedlStream__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          doosan_m0609_msgs__msg__SpeedlStream__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!doosan_m0609_msgs__msg__SpeedlStream__copy(
