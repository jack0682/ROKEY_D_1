...
#include "doosan_m0609_controller/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // error_message, robot_state
#include "rosidl_runtime_c/string_functions.h"  // error_message, robot_state
...
using _RobotStatus__ros_msg_type = doosan_m0609_controller__msg__RobotStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: has_control_authority
  {
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doosan_m0609_controller__msg__RobotStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = doosan_m0609_controller__msg__RobotStatus;
    is_plain =
      (
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_doosan_m0609_controller__msg__RobotStatus(
