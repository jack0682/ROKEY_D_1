...
static const _MoveJ_Request_type_support_symbol_names_t _MoveJ_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_controller, srv, MoveJ_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_controller, srv, MoveJ_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_controller, srv, MoveJ_Request)() {
  return &::doosan_m0609_controller::srv::rosidl_typesupport_c::MoveJ_Request_message_type_support_handle;
}
...
static const _MoveJ_Response_type_support_symbol_names_t _MoveJ_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_controller, srv, MoveJ_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_controller, srv, MoveJ_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_controller, srv, MoveJ_Response)() {
  return &::doosan_m0609_controller::srv::rosidl_typesupport_c::MoveJ_Response_message_type_support_handle;
}
...
static const _MoveJ_type_support_symbol_names_t _MoveJ_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doosan_m0609_controller, srv, MoveJ)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, doosan_m0609_controller, srv, MoveJ)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, doosan_m0609_controller, srv, MoveJ)() {
  return &::doosan_m0609_controller::srv::rosidl_typesupport_c::MoveJ_service_type_support_handle;
}
