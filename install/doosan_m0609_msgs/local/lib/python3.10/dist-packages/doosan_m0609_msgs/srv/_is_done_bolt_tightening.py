...
class Metaclass_IsDoneBoltTightening(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.IsDoneBoltTightening')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _is_done_bolt_tightening
...
class IsDoneBoltTightening(metaclass=Metaclass_IsDoneBoltTightening):
    from doosan_m0609_msgs.srv._is_done_bolt_tightening import IsDoneBoltTightening_Request as Request
    from doosan_m0609_msgs.srv._is_done_bolt_tightening import IsDoneBoltTightening_Response as Response
