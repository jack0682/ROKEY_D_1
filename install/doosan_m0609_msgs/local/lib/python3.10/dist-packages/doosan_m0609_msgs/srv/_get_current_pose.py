...
class GetCurrentPose_Request(metaclass=Metaclass_GetCurrentPose_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.space_type = kwargs.get('space_type', int())
    ...
    def space_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'space_type' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'space_type' field must be an integer in [-128, 127]"
...
class Metaclass_GetCurrentPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetCurrentPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_current_pose
...
class GetCurrentPose(metaclass=Metaclass_GetCurrentPose):
    from doosan_m0609_msgs.srv._get_current_pose import GetCurrentPose_Request as Request
    from doosan_m0609_msgs.srv._get_current_pose import GetCurrentPose_Response as Response
