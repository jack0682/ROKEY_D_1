...
class Metaclass_ConfigCreateModbus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.ConfigCreateModbus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _config_create_modbus
...
class ConfigCreateModbus(metaclass=Metaclass_ConfigCreateModbus):
    from doosan_m0609_msgs.srv._config_create_modbus import ConfigCreateModbus_Request as Request
    from doosan_m0609_msgs.srv._config_create_modbus import ConfigCreateModbus_Response as Response
