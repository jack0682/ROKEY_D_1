...
class Metaclass_ParallelAxis1_Request(type):
    """Metaclass of message 'ParallelAxis1_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__parallel_axis1__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__parallel_axis1__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__parallel_axis1__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__parallel_axis1__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__parallel_axis1__request
...
class ParallelAxis1_Request(metaclass=Metaclass_ParallelAxis1_Request):
    """Message class 'ParallelAxis1_Request'."""
...
class Metaclass_ParallelAxis1_Response(type):
    """Metaclass of message 'ParallelAxis1_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__parallel_axis1__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__parallel_axis1__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__parallel_axis1__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__parallel_axis1__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__parallel_axis1__response
...
class ParallelAxis1_Response(metaclass=Metaclass_ParallelAxis1_Response):
    """Message class 'ParallelAxis1_Response'."""
...
class Metaclass_ParallelAxis1(type):
    """Metaclass of service 'ParallelAxis1'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.ParallelAxis1')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__parallel_axis1

            from doosan_m0609_msgs.srv import _parallel_axis1
            if _parallel_axis1.Metaclass_ParallelAxis1_Request._TYPE_SUPPORT is None:
                _parallel_axis1.Metaclass_ParallelAxis1_Request.__import_type_support__()
            if _parallel_axis1.Metaclass_ParallelAxis1_Response._TYPE_SUPPORT is None:
                _parallel_axis1.Metaclass_ParallelAxis1_Response.__import_type_support__()


class ParallelAxis1(metaclass=Metaclass_ParallelAxis1):
    from doosan_m0609_msgs.srv._parallel_axis1 import ParallelAxis1_Request as Request
    from doosan_m0609_msgs.srv._parallel_axis1 import ParallelAxis1_Response as Response
