...
class MoveHome_Response(metaclass=Metaclass_MoveHome_Response):
    ...
    def res(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'res' field must be an integer in [-128, 127]"
        self._res = value
...
class Metaclass_MoveHome(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveHome')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _move_home
...
class MoveHome(metaclass=Metaclass_MoveHome):
    from doosan_m0609_msgs.srv._move_home import MoveHome_Request as Request
    from doosan_m0609_msgs.srv._move_home import MoveHome_Response as Response
