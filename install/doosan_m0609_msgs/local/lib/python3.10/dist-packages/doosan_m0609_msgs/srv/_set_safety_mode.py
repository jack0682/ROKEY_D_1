...
class Metaclass_SetSafetyMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetSafetyMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _set_safety_mode
...
class SetSafetyMode(metaclass=Metaclass_SetSafetyMode):
    from doosan_m0609_msgs.srv._set_safety_mode import SetSafetyMode_Request as Request
    from doosan_m0609_msgs.srv._set_safety_mode import SetSafetyMode_Response as Response
