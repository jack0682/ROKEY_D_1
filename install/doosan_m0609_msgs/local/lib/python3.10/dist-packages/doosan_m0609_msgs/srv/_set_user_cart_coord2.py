...
class Metaclass_SetUserCartCoord2_Request(type):
    """Metaclass of message 'SetUserCartCoord2_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_user_cart_coord2__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_user_cart_coord2__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_user_cart_coord2__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_user_cart_coord2__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_user_cart_coord2__request
...
class SetUserCartCoord2_Request(metaclass=Metaclass_SetUserCartCoord2_Request):
    """Message class 'SetUserCartCoord2_Request'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'x1' not in kwargs:
            ...
            self.x1 = numpy.array(kwargs.get('x1'), dtype=numpy.float64)
            assert self.x1.shape == (6, )
        if 'x2' not in kwargs:
            self.x2 = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.x2 = numpy.array(kwargs.get('x2'), dtype=numpy.float64)
            assert self.x2.shape == (6, )
        if 'x3' not in kwargs:
            self.x3 = numpy.zeros(6, dtype=numpy.float64)
        else:
            self.x3 = numpy.array(kwargs.get('x3'), dtype=numpy.float64)
            assert self.x3.shape == (6, )
...
class Metaclass_SetUserCartCoord2_Response(type):
    """Metaclass of message 'SetUserCartCoord2_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_user_cart_coord2__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_user_cart_coord2__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_user_cart_coord2__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_user_cart_coord2__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_user_cart_coord2__response
...
class SetUserCartCoord2_Response(metaclass=Metaclass_SetUserCartCoord2_Response):
    """Message class 'SetUserCartCoord2_Response'."""
...
class Metaclass_SetUserCartCoord2(type):
    """Metaclass of service 'SetUserCartCoord2'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.SetUserCartCoord2')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__set_user_cart_coord2

            from doosan_m0609_msgs.srv import _set_user_cart_coord2
            if _set_user_cart_coord2.Metaclass_SetUserCartCoord2_Request._TYPE_SUPPORT is None:
                _set_user_cart_coord2.Metaclass_SetUserCartCoord2_Request.__import_type_support__()
            if _set_user_cart_coord2.Metaclass_SetUserCartCoord2_Response._TYPE_SUPPORT is None:
                _set_user_cart_coord2.Metaclass_SetUserCartCoord2_Response.__import_type_support__()


class SetUserCartCoord2(metaclass=Metaclass_SetUserCartCoord2):
    from doosan_m0609_msgs.srv._set_user_cart_coord2 import SetUserCartCoord2_Request as Request
    from doosan_m0609_msgs.srv._set_user_cart_coord2 import SetUserCartCoord2_Response as Response
