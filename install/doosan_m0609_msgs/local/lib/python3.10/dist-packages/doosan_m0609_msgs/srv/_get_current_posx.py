...
class Metaclass_GetCurrentPosx(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetCurrentPosx')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_current_posx
...
class GetCurrentPosx(metaclass=Metaclass_GetCurrentPosx):
    from doosan_m0609_msgs.srv._get_current_posx import GetCurrentPosx_Request as Request
    from doosan_m0609_msgs.srv._get_current_posx import GetCurrentPosx_Response as Response
