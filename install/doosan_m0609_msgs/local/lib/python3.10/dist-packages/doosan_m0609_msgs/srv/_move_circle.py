...
class Metaclass_MoveCircle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.MoveCircle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _move_circle
...
class MoveCircle(metaclass=Metaclass_MoveCircle):
    from doosan_m0609_msgs.srv._move_circle import MoveCircle_Request as Request
    from doosan_m0609_msgs.srv._move_circle import MoveCircle_Response as Response
