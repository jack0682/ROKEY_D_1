...
bool doosan_m0609_msgs__srv__move_spline_joint__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_spline_joint.MoveSplineJoint_Request", full_classname_dest, 64) == 0);
  }
  doosan_m0609_msgs__srv__MoveSplineJoint_Request * ros_message = _ros_message;
  {  // pos
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_spline_joint__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveSplineJoint_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._move_spline_joint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveSplineJoint_Request");
  ...
  doosan_m0609_msgs__srv__MoveSplineJoint_Request * ros_message = (doosan_m0609_msgs__srv__MoveSplineJoint_Request *)raw_ros_message;
  {  // pos
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool doosan_m0609_msgs__srv__move_spline_joint__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.srv._move_spline_joint.MoveSplineJoint_Response", full_classname_dest, 65) == 0);
  }
  doosan_m0609_msgs__srv__MoveSplineJoint_Response * ros_message = _ros_message;
  {  // success
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * doosan_m0609_msgs__srv__move_spline_joint__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MoveSplineJoint_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.srv._move_spline_joint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveSplineJoint_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  doosan_m0609_msgs__srv__MoveSplineJoint_Response * ros_message = (doosan_m0609_msgs__srv__MoveSplineJoint_Response *)raw_ros_message;
  {  // success
    PyObject * field = NULL;
