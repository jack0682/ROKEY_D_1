...
class Metaclass_GetWorkpieceWeight(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'doosan_m0609_msgs.srv.GetWorkpieceWeight')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from doosan_m0609_msgs.srv import _get_workpiece_weight
...
class GetWorkpieceWeight(metaclass=Metaclass_GetWorkpieceWeight):
    from doosan_m0609_msgs.srv._get_workpiece_weight import GetWorkpieceWeight_Request as Request
    from doosan_m0609_msgs.srv._get_workpiece_weight import GetWorkpieceWeight_Response as Response
