...
bool doosan_m0609_msgs__msg__log_alarm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("doosan_m0609_msgs.msg._log_alarm.LogAlarm", full_classname_dest, 41) == 0);
  }
  doosan_m0609_msgs__msg__LogAlarm * ros_message = _ros_message;
  {  // level
...
PyObject * doosan_m0609_msgs__msg__log_alarm__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("doosan_m0609_msgs.msg._log_alarm");
  ...
  doosan_m0609_msgs__msg__LogAlarm * ros_message = (doosan_m0609_msgs__msg__LogAlarm *)raw_ros_message;
  {  // level
    PyObject * field = NULL;
