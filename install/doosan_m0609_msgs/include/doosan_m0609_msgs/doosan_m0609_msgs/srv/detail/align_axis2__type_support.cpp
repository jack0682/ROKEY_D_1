...
{
  new (message_memory) doosan_m0609_msgs::srv::AlignAxis2_Request(_init);
}

void AlignAxis2_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::srv::AlignAxis2_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AlignAxis2_Request_message_member_array[4] = {
  {
    ...
    offsetof(doosan_m0609_msgs::srv::AlignAxis2_Request, target_vect),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::AlignAxis2_Request, source_vect),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::AlignAxis2_Request, axis),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::AlignAxis2_Request, ref),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AlignAxis2_Request_message_members = {
  ...
  4,  // number of fields
  sizeof(doosan_m0609_msgs::srv::AlignAxis2_Request),
...
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::AlignAxis2_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, AlignAxis2_Request)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::AlignAxis2_Request_message_type_support_handle;
}
...
void AlignAxis2_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) doosan_m0609_msgs::srv::AlignAxis2_Response(_init);
}

void AlignAxis2_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::srv::AlignAxis2_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AlignAxis2_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::srv::AlignAxis2_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AlignAxis2_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(doosan_m0609_msgs::srv::AlignAxis2_Response),
...
{
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::AlignAxis2_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, AlignAxis2_Response)() {
  return &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::AlignAxis2_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AlignAxis2_service_members = {
  ...
  // see get_service_type_support_handle<doosan_m0609_msgs::srv::AlignAxis2>()
...
get_service_type_support_handle<doosan_m0609_msgs::srv::AlignAxis2>()
{
  ...
  auto service_type_support =
    &::doosan_m0609_msgs::srv::rosidl_typesupport_introspection_cpp::AlignAxis2_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, srv, AlignAxis2)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<doosan_m0609_msgs::srv::AlignAxis2>();
}
