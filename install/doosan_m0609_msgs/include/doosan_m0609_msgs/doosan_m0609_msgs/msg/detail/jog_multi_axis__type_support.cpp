...
{
  new (message_memory) doosan_m0609_msgs::msg::JogMultiAxis(_init);
}

void JogMultiAxis_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::msg::JogMultiAxis *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JogMultiAxis_message_member_array[3] = {
  {
    ...
    offsetof(doosan_m0609_msgs::msg::JogMultiAxis, jog_axis),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::JogMultiAxis, move_reference),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::JogMultiAxis, speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JogMultiAxis_message_members = {
  ...
  3,  // number of fields
  sizeof(doosan_m0609_msgs::msg::JogMultiAxis),
...
{
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::JogMultiAxis_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, msg, JogMultiAxis)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::JogMultiAxis_message_type_support_handle;
}
