...
{
  new (message_memory) doosan_m0609_msgs::msg::ServolRtStream(_init);
}

void ServolRtStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::msg::ServolRtStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServolRtStream_message_member_array[4] = {
  {
    ...
    offsetof(doosan_m0609_msgs::msg::ServolRtStream, pos),  // bytes offset in struct
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolRtStream, vel),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolRtStream, acc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolRtStream, time),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServolRtStream_message_members = {
  ...
  4,  // number of fields
  sizeof(doosan_m0609_msgs::msg::ServolRtStream),
...
{
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::ServolRtStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, msg, ServolRtStream)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::ServolRtStream_message_type_support_handle;
}
