...
#ifndef DOOSAN_M0609_MSGS__MSG__DETAIL__LOG_ALARM__STRUCT_HPP_
#define DOOSAN_M0609_MSGS__MSG__DETAIL__LOG_ALARM__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__doosan_m0609_msgs__msg__LogAlarm __attribute__((deprecated))
#else
# define DEPRECATED__doosan_m0609_msgs__msg__LogAlarm __declspec(deprecated)
#endif
...
struct LogAlarm_
{
  ...
  using ConstRawPtr =
    const doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__doosan_m0609_msgs__msg__LogAlarm
    std::shared_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__doosan_m0609_msgs__msg__LogAlarm
    std::shared_ptr<doosan_m0609_msgs::msg::LogAlarm_<ContainerAllocator> const>
...
using LogAlarm =
  doosan_m0609_msgs::msg::LogAlarm_<std::allocator<void>>;
...
#endif  // DOOSAN_M0609_MSGS__MSG__DETAIL__LOG_ALARM__STRUCT_HPP_
