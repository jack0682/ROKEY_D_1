...
{
  new (message_memory) doosan_m0609_msgs::msg::ServolStream(_init);
}

void ServolStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::msg::ServolStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServolStream_message_member_array[4] = {
  {
    ...
    offsetof(doosan_m0609_msgs::msg::ServolStream, pos),  // bytes offset in struct
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolStream, vel),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolStream, acc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::ServolStream, time),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServolStream_message_members = {
  ...
  4,  // number of fields
  sizeof(doosan_m0609_msgs::msg::ServolStream),
...
{
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::ServolStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, msg, ServolStream)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::ServolStream_message_type_support_handle;
}
