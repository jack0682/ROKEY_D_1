...
{
  new (message_memory) doosan_m0609_msgs::msg::SpeedlRtStream(_init);
}

void SpeedlRtStream_fini_function(void * message_memory)
{
  auto typed_message = static_cast<doosan_m0609_msgs::msg::SpeedlRtStream *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedlRtStream_message_member_array[3] = {
  {
    ...
    offsetof(doosan_m0609_msgs::msg::SpeedlRtStream, vel),  // bytes offset in struct
  ...
  },
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::SpeedlRtStream, acc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(doosan_m0609_msgs::msg::SpeedlRtStream, time),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SpeedlRtStream_message_members = {
  ...
  3,  // number of fields
  sizeof(doosan_m0609_msgs::msg::SpeedlRtStream),
...
{
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::SpeedlRtStream_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, doosan_m0609_msgs, msg, SpeedlRtStream)() {
  return &::doosan_m0609_msgs::msg::rosidl_typesupport_introspection_cpp::SpeedlRtStream_message_type_support_handle;
}
