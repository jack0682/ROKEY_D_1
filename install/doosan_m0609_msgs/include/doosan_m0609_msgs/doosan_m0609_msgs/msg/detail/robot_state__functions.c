...
bool
doosan_m0609_msgs__msg__RobotState__init(doosan_m0609_msgs__msg__RobotState * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_state_str)) {
    doosan_m0609_msgs__msg__RobotState__fini(msg);
    return false;
  }
  // actual_mode
  // actual_space
  ...
  // modbus_state
  if (!doosan_m0609_msgs__msg__ModbusState__Sequence__init(&msg->modbus_state, 0)) {
    doosan_m0609_msgs__msg__RobotState__fini(msg);
    return false;
  }
  // access_control
...
void
doosan_m0609_msgs__msg__RobotState__fini(doosan_m0609_msgs__msg__RobotState * msg)
{
  if (!msg) {
    return;
  }
  ...
  // flange_digital_output
  // modbus_state
  doosan_m0609_msgs__msg__ModbusState__Sequence__fini(&msg->modbus_state);
  // access_control
  // homming_completed
  // tp_initialized
  // mastering_need
...
bool
doosan_m0609_msgs__msg__RobotState__are_equal(const doosan_m0609_msgs__msg__RobotState * lhs, const doosan_m0609_msgs__msg__RobotState * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // modbus_state
  if (!doosan_m0609_msgs__msg__ModbusState__Sequence__are_equal(
...
bool
doosan_m0609_msgs__msg__RobotState__copy(
  const doosan_m0609_msgs__msg__RobotState * input,
  doosan_m0609_msgs__msg__RobotState * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // modbus_state
  if (!doosan_m0609_msgs__msg__ModbusState__Sequence__copy(
...
doosan_m0609_msgs__msg__RobotState *
doosan_m0609_msgs__msg__RobotState__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  doosan_m0609_msgs__msg__RobotState * msg = (doosan_m0609_msgs__msg__RobotState *)allocator.allocate(sizeof(doosan_m0609_msgs__msg__RobotState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(doosan_m0609_msgs__msg__RobotState));
  bool success = doosan_m0609_msgs__msg__RobotState__init(msg);
  if (!success) {
...
void
doosan_m0609_msgs__msg__RobotState__destroy(doosan_m0609_msgs__msg__RobotState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    doosan_m0609_msgs__msg__RobotState__fini(msg);
...
bool
doosan_m0609_msgs__msg__RobotState__Sequence__init(doosan_m0609_msgs__msg__RobotState__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  doosan_m0609_msgs__msg__RobotState * data = NULL;

  if (size) {
    data = (doosan_m0609_msgs__msg__RobotState *)allocator.zero_allocate(size, sizeof(doosan_m0609_msgs__msg__RobotState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = doosan_m0609_msgs__msg__RobotState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        doosan_m0609_msgs__msg__RobotState__fini(&data[i - 1]);
      }
...
void
doosan_m0609_msgs__msg__RobotState__Sequence__fini(doosan_m0609_msgs__msg__RobotState__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      doosan_m0609_msgs__msg__RobotState__fini(&array->data[i]);
    }
...
doosan_m0609_msgs__msg__RobotState__Sequence *
doosan_m0609_msgs__msg__RobotState__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  doosan_m0609_msgs__msg__RobotState__Sequence * array = (doosan_m0609_msgs__msg__RobotState__Sequence *)allocator.allocate(sizeof(doosan_m0609_msgs__msg__RobotState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = doosan_m0609_msgs__msg__RobotState__Sequence__init(array, size);
  if (!success) {
...
void
doosan_m0609_msgs__msg__RobotState__Sequence__destroy(doosan_m0609_msgs__msg__RobotState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    doosan_m0609_msgs__msg__RobotState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
doosan_m0609_msgs__msg__RobotState__Sequence__are_equal(const doosan_m0609_msgs__msg__RobotState__Sequence * lhs, const doosan_m0609_msgs__msg__RobotState__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!doosan_m0609_msgs__msg__RobotState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
doosan_m0609_msgs__msg__RobotState__Sequence__copy(
  const doosan_m0609_msgs__msg__RobotState__Sequence * input,
  doosan_m0609_msgs__msg__RobotState__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(doosan_m0609_msgs__msg__RobotState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    doosan_m0609_msgs__msg__RobotState * data =
      (doosan_m0609_msgs__msg__RobotState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!doosan_m0609_msgs__msg__RobotState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          doosan_m0609_msgs__msg__RobotState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!doosan_m0609_msgs__msg__RobotState__copy(
