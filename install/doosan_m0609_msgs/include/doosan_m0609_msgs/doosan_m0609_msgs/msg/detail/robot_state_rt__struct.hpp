...
#ifndef DOOSAN_M0609_MSGS__MSG__DETAIL__ROBOT_STATE_RT__STRUCT_HPP_
#define DOOSAN_M0609_MSGS__MSG__DETAIL__ROBOT_STATE_RT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__doosan_m0609_msgs__msg__RobotStateRt __attribute__((deprecated))
#else
# define DEPRECATED__doosan_m0609_msgs__msg__RobotStateRt __declspec(deprecated)
#endif
...
struct RobotStateRt_
{
  ...
  using ConstRawPtr =
    const doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__doosan_m0609_msgs__msg__RobotStateRt
    std::shared_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__doosan_m0609_msgs__msg__RobotStateRt
    std::shared_ptr<doosan_m0609_msgs::msg::RobotStateRt_<ContainerAllocator> const>
...
using RobotStateRt =
  doosan_m0609_msgs::msg::RobotStateRt_<std::allocator<void>>;
...
#endif  // DOOSAN_M0609_MSGS__MSG__DETAIL__ROBOT_STATE_RT__STRUCT_HPP_
